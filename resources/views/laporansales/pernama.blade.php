<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Rekap Penjualan Sales Pernama') }}
        </h2>
    </x-slot>
                                    ...
                                    <form action="{{ url()->current() }}">
                                        <div class="input-group">
                                            <select name="filter" class="form-control input-sm select2 rounded-xl">
                                                ...
                                                <option value="{{ $item->id_salesmaster }}" {{ $item->id_salesmaster ==
                                                    old('filter', $filter) ? 'selected' : '' }}>
                                                    {{ strtoupper($item->salesmaster->name) }}</option>
                                                @endforeach
                                            </select>
