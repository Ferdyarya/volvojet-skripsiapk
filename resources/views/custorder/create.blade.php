<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {!! __('Customer Order &raquo; Create') !!}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="">
                ...
                @endif
                <form action="{{ route('custorder.store') }}" class="w-full" method="POST"
                    ...
                    <div class="flex flex-1/5 -mx-3 mb-6 hapus">
                        ...
                        <div class="w-full px-3">
                            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                for="grid-last-name">Part Order</label>
                            <input value="{{ old('order_product') }}" name="order_product[]"
                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
