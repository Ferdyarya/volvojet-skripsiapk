<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="mb-3">
                    <a href="{{ route('customermaster.create') }}"
                        class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Create Customer Master Data</a>
                    <div class="flex justify-start mt-7">
                        <div class=" xl:w-96 ">
                            <form action="customermaster" method="GET">
                ...
                <div class="bg-white">
                    <table class="table-auto w-full">
                        ...
                        <tbody>
                            @forelse ($customermaster as $item)
                            <tr>
                                ...
                                <td class="border px-6 py-4 text-center">
                                    ...
                                    <form action="{{ route('customermaster.destroy', $item->id) }}" method="POST"
                                        class="inline-block">
