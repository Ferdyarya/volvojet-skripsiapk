    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="">
                ...
                @endif
                <form action="{{ route('brgkeluar.store') }}" class="w-full" method="POST"
                    ...
                    <div class="flex flex-1/5 -mx-3 mb-6 hapus">
                        <div class="w-full px-3">
                            ...
                            <input value="{{ old('partkeluar') }}" name="partkeluar[]"
                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-last-name" type="text" step="0.01" placeholder="Part Keluar">
                        </div>
